...
export default function FundPage() {
    const [form, setForm] = useState({ type: "in", amount: "", source: "", date: "", notes: "" })
    ...
    function addRecord(e) {
        ...
        const r = { id: Date.now(), ...form, amount: signed }
    ...
    const quickAdd = (amt, type = "in") => {
        const signed = type === "in" ? Math.abs(amt) : -Math.abs(amt)
        const r = { id: Date.now(), type, amount: signed, source: "Quick", date: new Date().toISOString().slice(0,10), notes: "" }
        setRecords(prev => [r, ...prev])
    }
            ...
            <div className="max-w-4xl mx-auto">
                <div className="bg-white shadow-xl rounded-2xl p-6">
                    <header className="flex items-center justify-between mb-6">
                        <h1 className="text-2xl font-extrabold text-emerald-700">Fund Manager</h1>
