          ...
          <div className="p-4 bg-white rounded-xl shadow-md mb-6 h-full relative">
            ...
            {showForm && (
              <form onSubmit={createActivity} className="mt-4 grid gap-2 grid-cols-1 sm:grid-cols-5 items-end">
                ...
                <div className="sm:col-span-1">
                  <label className="text-xs text-slate-600">Lecturer</label>
                  <input
                    value={lecturer}
            ...
            <div className="mt-6">
              ...
              <ul className="mt-4 space-y-3">
                {timetable.map(activity => (
                  ...
                  >
                    <div>
                      <div className="text-sm font-medium text-slate-800">{activity.course}</div>
                      <div className="text-xs text-slate-500">
                        {activity.date} {activity.time}
                      </div>
                      <div className="text-sm text-slate-600 mt-1">Lecturer: {activity.lecturer}</div>
                      <div className="text-sm text-slate-600 mt-1">Location: {activity.location}</div>
                    </div>
